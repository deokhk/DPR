...
def main(args, logger):
    ...
    with open(os.path.join(args.out_dir, "nq_train_with_table_upsampled.json"), 'w') as f:
    ...
    with open(os.path.join(args.out_dir, "nq_train_table_only_upsampled.json"), 'w') as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--total_train_path", help="path to the retrieval text+table json train file", 
        default="/home1/deokhk_1/research/MultiQA_data/retriever/plain/nq-train-text-table_without_special_token.json")
    parser.add_argument("--table_train_path", help="path to the retrieval table-only json file",
        default="/home1/deokhk_1/research/MultiQA_data/retriever/plain/table_train_without_special_token.json")
    parser.add_argument("--out_dir", help="output path where the augmented encoder train/dev will be saved",
        default="/home1/deokhk_1/research/MultiQA_data/retriever/plain/")
